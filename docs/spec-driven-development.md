...
| F0004  | client-credentials-auth | Authentication (client identity) | draft (spec only, no slices started) | F0004.1, F0004.2 | `docs/features/F0004-client-credentials-auth.md` |
