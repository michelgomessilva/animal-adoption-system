...
| F0005  | problem-details-error-responses | Cross-cutting (API error handling) | draft — spec created, no slice started | F0005.1 (single-slice feature) | `docs/features/F0005-problem-details-error-responses.md` |
