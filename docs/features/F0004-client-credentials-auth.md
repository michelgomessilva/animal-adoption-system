...
| -------- | -------------------------- | ---------------------------------------------- | ----------- |
| F0004.1  | client-entity-and-token-issuance | Config-sourced `client_id`/`client_secret` (no DB entity, revised 2026-08-25) + `POST /oauth/token` issuance endpoint. | spec created / in research |
